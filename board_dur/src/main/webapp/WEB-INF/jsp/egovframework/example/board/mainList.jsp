...
//검색
function updateInputId(value) {
	  var labelFor = "";
	  var inputId = "";
	  var inputName = "";

	  if (value === "title") {
	    labelFor = "searchKeyword";
	    inputId = "searchKeyword";
	    inputName = "searchKeyword";
	  } else if (value === "writer") {
	    labelFor = "searchWriter";
	    inputId = "searchWriter";
	    inputName = "searchWriter";
	  }

	  document.querySelector("label[for='searchKeyword']").setAttribute("for", labelFor);
	  document.getElementById("searchKeyword").setAttribute("id", inputId);
	  document.getElementById("searchKeyword").setAttribute("name", inputName);
	}
// 검색
</script>
<style>
		...
		<div class="panel-body">
			...
			<form class="form-inline" method="post" action="/mainList.do">
			  <div class="form-group">
			    ...
			    <!-- 검색 조건 선택 -->
			    <select id="search_select" name="searchType" onchange="updateInputId(this.value)">
