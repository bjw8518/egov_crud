    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal" id="boardRegForm" name="boardRegForm" method="post" action="/">
                ...
                <!-- 일반게시판 -->
                <div id="nomal_board" class="boardform">
                    내용
                </div>
                <!-- 일반게시판 -->
                ...
                <div id="vote_board" class="boardform">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="endDate">투표마감일</label>
                        <div class="col-sm-10">
                            <input type="datetime-local" class="form-control" id="endDate" name="endDate"
                                placeholder="투표마감일 입력하세요">
                        </div>
                    </div>
                    
                    <div class="form-group">
				<label class="control-label col-sm-2" for="choices">투표 선택지:</label>
				<div class="col-sm-10" id="choicesContainer">
					<!-- 이곳에 투표 선택지 입력 필드가 추가됩니다 -->
				</div>
				<button type="button" class="btn btn-default" id="addChoiceBtn">투표 선택지 추가</button>
			</div>
                </div>
                <!-- 투표게시판 -->

                <!-- 자유게시판 -->
                <div id="free_board" class="boardform">
                    내용
                </div>
                <!-- 자유게시판 -->
            </form>
